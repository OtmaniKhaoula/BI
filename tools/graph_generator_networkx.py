...
edges = pd.read_csv('../data/graphs/edges/dept-84-edges.csv', sep = ';')
nodes = pd.read_csv('../data/graphs/nodes/dept-84-nodes.csv', sep = ';')
...
plt.title('Bar Plot betweenness centrality')
...
G.show('Dept-84.html', notebook=False)
